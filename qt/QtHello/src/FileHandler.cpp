...
bool QtSample::FileHandler::ReadTextFile(std::string_view path, std::string* content)
{
	bool loaded = false;
...
bool QtSample::FileHandler::WriteTextFile(std::string_view path, std::string content)
{
	bool stored = false;
...
bool QtSample::FileHandler::ReadBinFile(std::string_view path, std::byte** content, size_t* fileSize)
{
	bool loaded = false;
	std::ifstream fileStream;
	fileStream.exceptions(std::ifstream::badbit | std::ifstream::failbit);
...
bool QtSample::FileHandler::WriteBinFile(std::string_view path, std::byte* content, size_t dataSize)
{
	bool stored = false;
	std::ofstream fileStream;
	fileStream.exceptions(std::ofstream::badbit | std::ofstream::failbit);
...
bool QtSample::FileHandler::ReadBinFile(std::string_view path, std::shared_ptr<RawBuffer>* content)
{
	bool loaded = false;
	std::ifstream fileStream;
	fileStream.exceptions(std::ifstream::badbit | std::ifstream::failbit);
...
bool QtSample::FileHandler::WriteBinFile(std::string_view path, const std::shared_ptr<RawBuffer>& content)
{
	bool stored = false;
	std::ofstream fileStream;
	fileStream.exceptions(std::ofstream::badbit | std::ofstream::failbit);
...
bool QtSample::FileHandler::FileExists(std::string_view path)
{
	bool loaded = false;
	std::ifstream fileStream;
